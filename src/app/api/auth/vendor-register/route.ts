...
export async function POST(req: NextRequest) {
  try {
    ...
    const {
      username, email, password, phone, whatsapp,
      businessName, description, secretQuestion, secretAnswer,
    } = parse.data
    ...
    return NextResponse.json(
      {
        success: true,
        message: 'Vendor account created. Submit verification to start selling.',
        data: {
          id:       String(user._id),
